...
public class GPSTracker extends Service implements LocationListener {
    ...
    private Location getLastKnownLocation() {
        ...
        if(mFusedLocationClient != null && mFusedLocationClient.getLastLocation() != null){
            if(mFusedLocationClient.getLastLocation().isComplete()) {
                Location fused = mFusedLocationClient.getLastLocation().getResult();
