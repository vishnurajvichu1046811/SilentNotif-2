...
public class LocationUpdatesService extends Service {
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if (!mChangingConfiguration && com.example.silentnotif2.Utility.Utils.requestingLocationUpdates(this)) {
    ...
    public void requestLocationUpdates() {
        ...
        com.example.silentnotif2.Utility.Utils.setRequestingLocationUpdates(this, true);
